...
public sealed class AngularCardMapper : AngularMapperBase
{
...
public sealed class AngularIconMapper : AngularMapperBase
{
...
public sealed class AngularBadgeMapper : AngularMapperBase
{
...
public sealed class AngularAvatarMapper : AngularMapperBase
{
...
public sealed class AngularTableMapper : AngularMapperBase
{
...
public sealed class AngularListMapper : AngularMapperBase
{
...
public sealed class AngularNavbarMapper : AngularMapperBase
{
...
public sealed class AngularSidebarMapper : AngularMapperBase
{
...
public sealed class AngularModalMapper : AngularMapperBase
{
...
public sealed class AngularDrawerMapper : AngularMapperBase
{
...
public sealed class AngularTooltipMapper : AngularMapperBase
{
...
public sealed class AngularTabsMapper : AngularMapperBase
{
...
public sealed class AngularAccordionMapper : AngularMapperBase
{
...
public sealed class AngularBreadcrumbMapper : AngularMapperBase
{
  ...
  protected override string EmitElement(IRNode node, EmitContext ctx)
  {
    ...
    foreach (var (part, idx) in parts.Select((p, i) => (p, i)))
    {
      ...
      var slug = part.ToLower().Replace(' ', '-');
      sb.Append($"{inner}<li><a routerLink=\"/{slug}\"{ariaCurrent}>{part}</a></li>\n");
    }

    var listHtml = $"{ctx.Indent}  <ol style=\"display:flex; list-style:none; margin:0; padding:0;\">\n{sb}{ctx.Indent}  </ol>\n";
    return Paired("nav", " aria-label=\"breadcrumb\"" + NodeClass(node), listHtml, ctx.Indent);
  }
}

public sealed class AngularPaginationMapper : AngularMapperBase
{
  ...
  protected override string EmitElement(IRNode node, EmitContext ctx)
  {
    ...
    var listHtml = $"{ctx.Indent}  <ul style=\"display:flex; list-style:none; margin:0; padding:0;\">\n{sb}{ctx.Indent}  </ul>\n";
